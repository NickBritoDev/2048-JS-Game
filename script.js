...
function addRandomTile() {
    const emptyTiles = Array.from(document.querySelectorAll(".tile[data-value='0']"));
...
function moveTiles(direction) {
    let tiles = Array.from(document.querySelectorAll(".tile")).map(tile => Number(tile.getAttribute("data-value")));
    let moved = false;
